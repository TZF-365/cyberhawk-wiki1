---
{"dg-publish":true,"permalink":"/pkm-lm/a-few-of-our-favorite-obsidian-plugins/"}
---
...
This is my favorite plugin, hands down. I can't recommend it enough. And if you want to read more about how I use it, check out [[PKM LM/Mike's Obsidian-Based Writing Workflow\|Mike's Obsidian-Based Writing Workflow]].
...
*Update: You can now do this using a Core plugin that you can read about in [[PKM LM/Splitting Notes in Obsidian\|Splitting Notes in Obsidian]]. But Note Refactor is still the power user tool of choice.*
...
It's pretty simple as far as plugins go, but it makes Obsidian an even better writing tool. If you want to know more, check out [[PKM LM/Turning Obsidian into the Perfect Writing App\|Turning Obsidian into the Perfect Writing App]].
...
This is a great plugin for anyone who keeps tasks in Todoist but wants a way to visualize those tasks alongside project information inside of Obsidian. If you want to see it in action, check out [[PKM LM/Syncing and Embedding Tasks with Todoist\|Syncing and Embedding Tasks with Todoist]].

### Tracker

The [Tracker Plugin](https://github.com/pyrochlore/obsidian-tracker) is the heart and soul of my [[PKM LM/Daily Questions in Obsidian\|Daily Questions in Obsidian]] journaling workflow. What it does is take values (in my case, numeric values associated with specific tags) and plots them on a graph. Here's a side-by-side screenshot of the code snippets in Edit Mode and what it looks like rendered in Preview Mode:
...
I walk through the whole process in setting this up in [[PKM LM/YAML & Dataview\|YAML & Dataview]].
